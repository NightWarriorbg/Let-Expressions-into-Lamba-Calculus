...
simpleTests =
    [ -- Challenge 1
      [ alphaNorm (LamApp (LamVar 1) (LamVar 0)) == LamApp (LamVar 1) (LamVar 0),
        ...
        alphaNorm (LamApp (LamAbs 1 (LamApp (LamVar 1) (LamVar 2))) (LamVar 3)) == LamApp (LamAbs 1 (LamApp (LamVar 1) (LamVar 2))) (LamVar 3),
        alphaNorm (LamAbs 1 (LamVar 2)) == (LamAbs 0 (LamVar 2)),
      ...
      [ -- Challenge 2
        ...
        countAllReds (LamApp (LamAbs 1 (LamApp (LamVar 1) (LamVar 2))) (LamVar 3)) 3 == 2,
        countAllReds (LamAbs 1 (LamVar 2)) 3 == 1,
        countAllReds (LamVar 1) 3 == 1
      ],
      [ -- Challenge 3 (but note that additional spaces will be accepted)
        ...
        printLambda (LamApp (LamAbs 1 (LamApp (LamVar 1) (LamVar 2))) (LamVar 3)) == "(\\x1 -> x1 x2) x3",
        printLambda (LamAbs 1 (LamVar 2)) == "\\x1 -> x2",
        printLambda (LamVar 1) == "x1"
      ],
      [ -- Challenge 4
        ...
        parseLet "let f1 x1 = x2; f2 x3 = x4 in f1 x1" == Just (LetDef [([1,1],LetVar 2),([2,3],LetVar 4)] (LetApp (LetFun 1) (LetVar 1))),
        parseLet "let x1 = x2; x3 = x4" == Nothing,
        parseLet "let x1 = x2 in x1 x2" == Nothing
      ],
      ...
      [ -- Challenge 6 (but note that equivalent answers will be accepted)
        ...
        lambdaToLet (LamApp (LamAbs 1 (LamApp (LamVar 1) (LamVar 2))) (LamVar 3)) == LetDef [] (LetApp (LetFun 1) (LetVar 3)),
        lambdaToLet (LamAbs 1 (LamVar 2)) == LetDef [([1,2],LetVar 2)] (LetFun 1),
        lambdaToLet (LamVar 1) == LetDef [] (LetVar (-1))
      ]
    ]
